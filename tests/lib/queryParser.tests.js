...
describe("queryParser.js", function() {
  ...
  describe("/?presets", function() {
    it("presets=1,2,3,4 should return ['1','2','3','4']", function() {
      ...
      queryParser(queryString, locale).presets.should.containDeep(['1','2','3','4']);
    });
    it("presets=1,2,3, should return the defaultSinglePresets values", function() {
      queryString.presets = "1,2,3,";
      queryParser(queryString, locale).presets.should.equal(defaultSinglePresets);
    });
  ...
  describe("/?frequency", function() {
    ...
    it("frequency=monthly should return defaultMonthlyPresets", function() {
      ...
      queryParser(queryString, locale).presets.should.equal(defaultMonthlyPresets);
    });
  ...
  describe("/?currency", function() {
    it("default should equal to 'usd' object", function() {
      queryParser(queryString, locale).currency.should.be.an.Object().and.containEql({ code: 'usd'});
    });
    it("/?currency=gbp should return 'gbp' currency object", function() {
      queryString.currency = "gbp";
      queryParser(queryString, locale).currency.should.be.an.Object().and.containEql({ symbol: '£'});
    });
    ...
    it("/?currency=blah should return default 'usd' object", function() {
      queryString.currency = "blah";
      queryParser(queryString, locale).currency.should.be.an.Object().and.containEql({ symbol: '$', code: 'usd'});
    });
  });
  describe("/?amount", function() {
    it("default should equal to null", function() {
      queryParser(queryString, locale).amount.should.be.empty();
    });
    ...
    it("/?amount=123 should return 123", function() {
      ...
      queryParser(queryString, locale).amount.should.be.equal('123');
    });
